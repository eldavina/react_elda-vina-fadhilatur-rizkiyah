...
import {
	getDetailProductsByIdQuery,
	updateProductsMutationbyIdMutation,
...
const EditProduct = () => {
	...
	const createproduct = editdata ? editdata.products[0] : [];

	const regex = /[a-zA-Z0-9]+([_ -]?[a-zA-Z0-9])*$/;

	const [updateProducts, { loading: loadingedit }] = useMutation(
		updateProductsMutationbyIdMutation
	);
	...
	useEffect(() => {
		formik.values.name = createproduct.name;
		formik.values.category = createproduct.category;
		formik.values.freshness = createproduct.freshness;
		formik.values.description = createproduct.description;
		formik.values.price = createproduct.price;
	}, [createproduct]);
